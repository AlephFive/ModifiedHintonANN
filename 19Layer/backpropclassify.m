...
w_class = 0.1*randn(size(w19,2)+1,10);
...
%%%%%%%%%%%%%%% PERFORM CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  if epoch<6  % First update top-level weights holding other weights fixed. 
    ...
    VV = [w_class(:)']';
    Dim = [l20; l21];
    [X, fX] = minimize(VV,'CG_CLASSIFY_INIT',max_iter,Dim,w19probs,targets);
    w_class = reshape(X,l20+1,l21);

  else
    VV = [w1(:)' w2(:)' w3(:)' w4(:)' w5(:)' w6(:)' w7(:)' w8(:)' w9(:)' w10(:)' w11(:)' w12(:)' 
    w13(:)' w14(:)' w15(:)' w16(:)' w17(:)' w18(:)' w19(:)'
    w_class(:)']';
    Dim = [l1; l2; l3; l4; l5; l6; l7; l8; l9; l10; l11; l12; l13; l14; l15; l16; l17; l18; l19; l20; l21;];
    ...
    w_class = reshape(X(xxx+1:xxx+(l20+1)*l21),l20+1,l21);
...
%%%%%%%%%%%%%%% END OF CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 save mnistclassify_weights w1 w2 w3 w4 w5 w6 w7 w8 w9 w10 w11 w12 w13 w14 w15 w16 w17 w18 w19 w_class
