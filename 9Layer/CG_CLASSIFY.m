...
% Do decomversion.
 ...
 w_class = reshape(VV(xxx+1:xxx+(l10+1)*l11),l10+1,l11);
...
Ix_class=IO; 
dw_class =  w9probs'*Ix_class; 

Ix9 = (Ix_class*w_class').*w9probs.*(1-w9probs);
Ix9 = Ix9(:,1:end-1);
dw9 =  w9probs'*Ix9;
...
df = [dw1(:)' dw2(:)' dw3(:)' dw4(:)' dw5(:)' dw6(:)' dw7(:)' dw8(:)' dw9(:)' dw_class(:)']'; 
