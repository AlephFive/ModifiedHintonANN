...
w_class = 0.1*randn(size(w13,2)+1,10);
...
N=numcases;
 for batch = 1:numbatches
  ...
  targetout = exp(w13probs*w_class);
...
%%%%%%%%%%%%%%% PERFORM CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  if epoch<6  % First update top-level weights holding other weights fixed. 
    ...
    VV = [w_class(:)']';
    Dim = [l14; l15];
    [X, fX] = minimize(VV,'CG_CLASSIFY_INIT',max_iter,Dim,w13probs,targets);
    w_class = reshape(X,l14+1,l15);
    ...
    w_class = reshape(X(xxx+1:xxx+(l14+1)*l15),l14+1,l15);
...
%%%%%%%%%%%%%%% END OF CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 save mnistclassify_weights w1 w2 w3 w4 w5 w6 w7 w8 w9 w10 w11 w12 w13 w_class
