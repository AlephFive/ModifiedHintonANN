...
fprintf(1,'\nPretraining Layer 17 with RBM: %d-%d \n',numpen15,numpen16);
batchdata=batchposhidprobs;
numhid=numpen16;
restart=1;
rbm;
hidpen16=vishid; penrecbiases16=hidbiases; hidgenbiases16=visbiases;
save mnisthp16classify hidpen16 penrecbiases16 hidgenbiases16;

fprintf(1,'\nPretraining Layer 18 with RBM: %d-%d \n',numpen16,numpen17);
batchdata=batchposhidprobs;
numhid=numpen17;
restart=1;
rbm;
hidpen17=vishid; penrecbiases17=hidbiases; hidgenbiases17=visbiases;
save mnisthp17classify hidpen17 penrecbiases17 hidgenbiases17;

fprintf(1,'\nPretraining Layer 19 with RBM: %d-%d \n',numpen17,numpen18);
batchdata=batchposhidprobs;
numhid=numpen18;
restart=1;
rbm;
hidpen18=vishid; penrecbiases18=hidbiases; hidgenbiases18=visbiases;
save mnisthp18classify hidpen18 penrecbiases18 hidgenbiases18;

fprintf(1,'\nPretraining Layer 20 with RBM: %d-%d \n',numpen18,numpen19);
batchdata=batchposhidprobs;
numhid=numpen19;
restart=1;
rbm;
hidpen19=vishid; penrecbiases19=hidbiases; hidgenbiases19=visbiases;
save mnisthp19classify hidpen19 penrecbiases19 hidgenbiases19;

fprintf(1,'\nPretraining Layer 21 with RBM: %d-%d \n',numpen19,numpen20);
batchdata=batchposhidprobs;
numhid=numpen20;
restart=1;
rbm;
hidpen20=vishid; penrecbiases20=hidbiases; hidgenbiases20=visbiases;
save mnisthp20classify hidpen20 penrecbiases20 hidgenbiases20;

fprintf(1,'\nPretraining Layer 22 with RBM: %d-%d \n',numpen20,numpen21);
batchdata=batchposhidprobs;
numhid=numpen21;
restart=1;
rbm;
hidpen21=vishid; penrecbiases21=hidbiases; hidgenbiases21=visbiases;
save mnisthp21classify hidpen21 penrecbiases21 hidgenbiases21;
