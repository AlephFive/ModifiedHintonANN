...
% Do decomversion.
 ...
 xxx = xxx+(l14+1)*l15;
 w15 = reshape(VV(xxx+1:xxx+(l15+1)*l15),l15+1,l16);
 xxx = xxx+(l15+1)*l16;
 w16 = reshape(VV(xxx+1:xxx+(l16+1)*l16),l16+1,l17);
 xxx = xxx+(l16+1)*l17;
 w17 = reshape(VV(xxx+1:xxx+(l17+1)*l17),l17+1,l18);
 xxx = xxx+(l17+1)*l18;
 w18 = reshape(VV(xxx+1:xxx+(l18+1)*l18),l18+1,l19);
 xxx = xxx+(l18+1)*l19;
 w19 = reshape(VV(xxx+1:xxx+(l19+1)*l19),l19+1,l20);
 xxx = xxx+(l19+1)*l20;
 w20 = reshape(VV(xxx+1:xxx+(l20+1)*l20),l20+1,l21);
 xxx = xxx+(l20+1)*l21;
 w21 = reshape(VV(xxx+1:xxx+(l21+1)*l21),l21+1,l22);
 xxx = xxx+(l21+1)*l22;
 w22 = reshape(VV(xxx+1:xxx+(l22+1)*l22),l22+1,l23);
 xxx = xxx+(l22+1)*l23;
 
 w_class = reshape(VV(xxx+1:xxx+(l23+1)*l24),l23+1,l24);
%notice
...
Ix_class=IO; 
dw_class =  w22probs'*Ix_class; 

Ix22 = (Ix_class*w_class').*w22probs.*(1-w22probs);
Ix22 = Ix22(:,1:end-1);
dw22 =  w22probs'*Ix22;

%%new
Ix21 = (Ix22*w22').*w21probs.*(1-w21probs); 
Ix21 = Ix21(:,1:end-1);
dw21 =  w20probs'*Ix21;

Ix20 = (Ix21*w21').*w20probs.*(1-w20probs); 
Ix20 = Ix20(:,1:end-1);
dw20 =  w19probs'*Ix20;

Ix19 = (Ix20*w20').*w19probs.*(1-w19probs); 
Ix19 = Ix19(:,1:end-1);
dw19 =  w18probs'*Ix19;

Ix18 = (Ix19*w19').*w18probs.*(1-w18probs); 
Ix18 = Ix18(:,1:end-1);
dw18 =  w17probs'*Ix18;

Ix17 = (Ix18*w18').*w17probs.*(1-w17probs); 
Ix17 = Ix17(:,1:end-1);
dw17 =  w16probs'*Ix17;

Ix16 = (Ix17*w17').*w16probs.*(1-w16probs); 
Ix16 = Ix16(:,1:end-1);
dw16 =  w15probs'*Ix16;

Ix15 = (Ix16*w16').*w15probs.*(1-w15probs); 
Ix15 = Ix15(:,1:end-1);
dw15 =  w14probs'*Ix15;

Ix14 = (Ix15*w15').*w14probs.*(1-w14probs); 
Ix14 = Ix14(:,1:end-1);
dw14 =  w13probs'*Ix14;
...
dw12(:)' dw13(:)' dw14(:)' dw15(:)' dw16(:)' dw17(:)' dw18(:)' dw19(:)' dw20(:)' dw21(:)' dw22(:)'
dw_class(:)']'; 
