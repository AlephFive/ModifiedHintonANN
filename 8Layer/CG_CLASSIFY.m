...
% Do decomversion.
 ...
 w_class = reshape(VV(xxx+1:xxx+(l9+1)*l10),l9+1,l10);
...
Ix_class=IO; 
dw_class =  w8probs'*Ix_class; 

Ix8 = (Ix_class*w_class').*w8probs.*(1-w8probs);
Ix8 = Ix8(:,1:end-1);
dw8 =  w8probs'*Ix8;
...
df = [dw1(:)' dw2(:)' dw3(:)' dw4(:)' dw5(:)' dw6(:)' dw7(:)' dw8(:)' dw_class(:)']'; 
