...
w_class = 0.1*randn(size(w18,2)+1,10);
...
%%%%%%%%%%%%%%% PERFORM CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  if epoch<6  % First update top-level weights holding other weights fixed. 
    ...
    VV = [w_class(:)']';
    Dim = [l19; l20];
    [X, fX] = minimize(VV,'CG_CLASSIFY_INIT',max_iter,Dim,w18probs,targets);
    w_class = reshape(X,l19+1,l20);
    ...
    w_class = reshape(X(xxx+1:xxx+(l19+1)*l20),l19+1,l20);
...
%%%%%%%%%%%%%%% END OF CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 save mnistclassify_weights w1 w2 w3 w4 w5 w6 w7 w8 w9 w10 w11 w12 w13 w14 w15 w16 w17 w18 w_class
