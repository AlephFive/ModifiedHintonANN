...
w_class = 0.1*randn(size(w20,2)+1,10);
...
%%%%%%%%%%%%%%% PERFORM CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  if epoch<6  % First update top-level weights holding other weights fixed. 
    ...
    VV = [w_class(:)']';
    Dim = [l21; l22];
    [X, fX] = minimize(VV,'CG_CLASSIFY_INIT',max_iter,Dim,w20probs,targets);
    w_class = reshape(X,l21+1,l22);
    ...
    w_class = reshape(X(xxx+1:xxx+(l21+1)*l22),l21+1,l22);
...
%%%%%%%%%%%%%%% END OF CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 save mnistclassify_weights w1 w2 w3 w4 w5 w6 w7 w8 w9 w10 w11 w12 w13 w14 w15 w16 w17 w18 w19 w20 w_class
